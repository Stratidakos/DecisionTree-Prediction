...
grid_search.fit(df_fin_train, y_train)

best_parameters = grid_search.best_params_  
print(best_parameters)

#{'criterion': 'gini', 'max_depth': None, 'max_leaf_nodes': None, 'min_samples_leaf': 50, 'min_samples_split': 10}